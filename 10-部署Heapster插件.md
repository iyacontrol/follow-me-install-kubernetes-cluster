...
已经修改好的 yaml 文件见：[heapster](https://github.com/iyacontrol/follow-me-install-kubernetes-cluster/blob/master/manifests/heapster)。
...
注意：无需自己导出、修改和创建 ConfigMap，可以直接使用放在 manifests 目录下的 [ConfigMap 文件](https://github.com/iyacontrol/follow-me-install-kubernetes-cluster/blob/master/manifests/heapster/influxdb-cm.yaml)。
